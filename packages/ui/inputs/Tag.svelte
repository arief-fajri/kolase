...
<style lang="postcss">
  ...
  .svelte-tags-input-layout:hover {
	...
	.input-tags-wrapper:focus-within {
	...
	.sti-layout-disable,
	.sti-layout-disable input {
		cursor: not-allowed;
		background: #eaeaea;
	}

	.sti-layout-disable:hover,
	.sti-layout-disable:focus,
	.sti-layout-readonly:hover,
	.sti-layout-readonly:focus {
		border-color: #ccc;
	}

	.sti-layout-disable .svelte-tags-input-tag {
		background: #aeaeae;
	}

	.sti-layout-disable .svelte-tags-input-tag-remove {
		cursor: not-allowed;
	}
